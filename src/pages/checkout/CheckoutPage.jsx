...
const CheckoutPage = () => {
  ...
  return (
    <div className={styles.accountPage}>
      <SEO title="Checkout" description="Finalize sua compra na OnlyWave Store. Preencha seus dados, escolha o método de envio e pagamento." />
      <AccountHeader />
        ...
        <div className="checkout-page">
          <div className="checkout-content">
            <div className="checkout-steps">
              ...
              <div className={`step ${step >= 2 ? 'active' : ''}`}>2. Entrega</div>
              <div className="progress-line" />
